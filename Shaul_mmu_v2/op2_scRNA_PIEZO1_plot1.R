...
#Set variables ----
#Input
op2_scRNA_analysis="./output/op2_data_ready.rda"
op2_scRNA_fetchData="./output/op2_PIEZO1_condXP.rda"
#Output
out_boxplot1="output/op2/op2_mmu_PIEZO1.png"
out_excel1="output/op2/op2_mmu_PIEZO1_freqs.xlsx"
out_excel2="output/op2/op2_mmu_PIEZO1_expre.xlsx"
out_rda="output/op2/op2_mmu_PIEZO1_stats.rda"
...
for(cl_k in 1:length(classes)){
  ...
  #Get Piezo1 info
  Piezo1_n_cells=gs_n_v["Fam38a"]
  Piezo1_perc=gs_perc_v["Fam38a"]
  Piezo1_rank=gs_rank_v["Fam38a"]
  ...
  if(length(cells_indxs)>2){
    ...
    Piezo1_rank_exp=Piezo1_rank_m["Fam38a",]
  ...
  Piezo1_rank_exp_all=Piezo1_rank_exp_all["Fam38a"]
...
write.xlsx(info_df,file="./output/op2/op2_perc_PIEZO1.xlsx",sheetName = "perc_PIEZO1",
           col.names = T, row.names = F)

png("./output/op2/op2_perc_PIEZO1.png", units="in", width=22, height=12, res=300)
...
write.xlsx(exp_df,file="./output/op2/op2_exp_PIEZO1.xlsx",sheetName = "exp_PIEZO1",
           col.names = T, row.names = F)

png("./output/op2/op2_exp_PIEZO1.png", units="in", width=22, height=12, res=300)
exp_df=exp_df[,c(2,4)]
...
write.xlsx(x2, "./output/op2/op2_raw_exp_PIEZO1xcond.xlsx", sheetName="boxplot", 
           append=T, row.names = F)

png("./output/op2/op2_raw_exp_PIEZO1xcond.png", units="in", width=22, height=12, res=300)
  plot(p2)
dev.off()
