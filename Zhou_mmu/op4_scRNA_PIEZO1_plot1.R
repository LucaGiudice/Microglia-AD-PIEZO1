...
#Set variables ----
#Input
op2_scRNA_analysis="./output/op4_data_ready.rda"
op2_scRNA_fetchData="./output/op4_PIEZO1_condXP.rda"
#Output
out_boxplot1="output/op4/op4_mmu_PIEZO1.png"
out_excel1="output/op4/op4_mmu_PIEZO1_freqs.xlsx"
out_excel2="output/op4/op4_mmu_PIEZO1_expre.xlsx"
out_rda="output/op4/op4_mmu_PIEZO1_stats.rda"

#Load and normalize data ----
cat("Load data \n")
load(op2_scRNA_analysis)
load(op2_scRNA_fetchData)
...
write.xlsx(info_df,file="./output/op4/op4_perc_PIEZO1.xlsx",sheetName = "perc_PIEZO1",
           col.names = T, row.names = F)

png("./output/op4/op4_perc_PIEZO1.png", units="in", width=22, height=12, res=300)
...
write.xlsx(exp_df,file="./output/op4/op4_exp_PIEZO1.xlsx",sheetName = "exp_PIEZO1",
           col.names = T, row.names = F)

png("./output/op4/op4_exp_PIEZO1.png", units="in", width=22, height=12, res=300)
exp_df=exp_df[,c(2,4)]
...
x2$ident=Idents(object = seuObj)
x2=x2[,seq(1,7)]
x2=melt(x2)
colnames(x2)=c("Cell_types","Gene","Expression_value")
...
p2=ggplot(x2, aes(x=Gene, y=Expression_value, fill=Cell_types)) + geom_boxplot()
p2=p2 + theme(text = element_text(size=18)) + scale_fill_manual(values=c("gold1", "grey","blue","red"))

#Save the table of the plot
write.xlsx(x2, "./output/op4/op4_raw_exp_PIEZO1xcond.xlsx", sheetName="boxplot", 
           append=T, row.names = F)

png("./output/op4/op4_raw_exp_PIEZO1xcond.png", units="in", width=22, height=12, res=300)
  plot(p2)
dev.off()
